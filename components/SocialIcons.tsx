...
export function TwitterIcon({ size = 14, className = "" }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export function YoutubeIcon({ size = 14, className = "" }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const SOCIAL_ICONS = [FacebookIcon, TwitterIcon, LinkedinIcon, YoutubeIcon];
