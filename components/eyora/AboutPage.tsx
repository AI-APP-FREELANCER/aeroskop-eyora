...
const SECTIONS = [
  ...
  },
  {
    ...
    body: ["The coverage period follows from how the products are engineered: component selection, thermal design and production testing are all aimed at continuous operation well beyond that term."],
  ...
  },
  {
    ...
    body: [
      "Our engineers review device logs and configurations directly, and bring in the wider engineering team when an issue needs deeper investigation.",
      "Every Eyora product is covered by a five-year advance replacement warranty. If a unit or component fails within the warranty period, we send the replacement straight away, with no need to return the faulty hardware first.",
    ],
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-14 items-center">
              <div className="animate-fade-up">
                ...
                <p className="mt-6 text-base md:text-lg text-[var(--text-secondary)] max-w-xl leading-relaxed">
                  Our engineering team develops and maintains the full firmware stack in-house, covering ISP tuning, the H.265/H.264 encoding pipeline, ONVIF integration and the web interface.
                </p>
                <p className="mt-4 text-base md:text-lg text-[var(--text-secondary)] max-w-xl leading-relaxed">
                  Eyora is the security hardware brand of Aeroskop. We design, build and support our own IP cameras, network video recorders and PoE switches, and every unit is made in Bahrain.
                </p>
              </div>
        ...
        <section className="px-5 md:px-8 py-20 md:py-28">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-10 text-[var(--text-secondary)] leading-relaxed [&>p]:mt-4 first:[&>p]:mt-0">
            ...
            {SECTIONS.map((s, i) => (
              ...
              >
                ...
                <div>
                  ...
                  {s.body.map((p, bi) => (
                    <p key={bi} className="mt-3 text-[var(--text-secondary)] leading-relaxed">
                      {p}
                    </p>
                  ))}
                </div>
