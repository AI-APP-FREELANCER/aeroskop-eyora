    ...
    <footer className="px-5 md:px-8 pt-16 pb-10 border-t border-[var(--glass-border)]">
      <div className="max-w-7xl mx-auto grid md:grid-cols-[1.3fr_1fr_1fr] gap-12">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5">
            <li><a href="/about" className="text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">Why Eyora</a></li>
            ...
            <li><a href="/#why-eyora" className="text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">About</a></li>
