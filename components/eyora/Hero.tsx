...
export default function Hero() {
  ...
  return (
    <section id="top" className="relative pt-28 pb-8 sm:pt-32 sm:pb-16 md:pt-44 md:pb-24 px-5 md:px-8 overflow-hidden">
      <div
      ...
      <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-14 items-center">
        <div>
          <div key={`badge-${slide}`} className="animate-fade-up eyora-badge px-4 py-1.5 text-xs font-semibold tracking-wide uppercase mb-4 sm:mb-6">
          ...
          <p key={`sub-${slide}`} className="animate-fade-up delay-200 mt-4 sm:mt-6 text-base md:text-lg text-[var(--text-secondary)] max-w-xl leading-relaxed">
            {cur.sub}
          </p>
          ...
          <div className="animate-fade-up delay-300 mt-6 sm:mt-9 flex flex-wrap items-center gap-4">
          ...
          <div className="mt-6 sm:mt-10 flex items-center gap-2.5">
            {SLIDES.map((s, i) => (
              <button
                key={s.eyebrow}
